...
## 입력 위젯
Shiny에서는 입력 위젯을 컨트롯 위젯(control widgets)이라 부릅니다. 즉, 위젯을 통해서 앱을 컨트롤하기 때문입니다. 굳이 입력 위젯이라고 불렀던 것은 입력된 값을 통해서 기능이 컨트록되고, 중요한 대부분 컨트롤 위젯의 이름의 접미사가 "Input"이기 때문입니다.
